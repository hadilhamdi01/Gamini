    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="media">
                ...
                <a href="#">
                                                <span class="float-right text-info">Deliverée le <?php echo $row['date_reclamation']; ?><i
                    ...
                    <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> <?php echo $row['description']; ?>
                                            </p>
                   
                    <hr>
                    <div class="float-right">
                        <a class="btn btn-outline-warning" href="modification_reclamation.php"><i class="icofont-headphone-alt" ></i> Modifier</a>
                        <a class="btn btn-danger" href="#"><i class="icofont-refresh"></i> Supprimer</a>
                    </div>
                </div>
            </div>
<?php
