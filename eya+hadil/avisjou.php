            ...
            <div class="col-md-3">
                <div class="osahan-account-page-left shadow-sm bg h-100 customm-bg">
                    ...
                    <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="btn btn-outline-success" href="addavisjou.php"><i
                                    class="icofont-headphone-alt"></i>Ajouter votre avis</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="bg card mb-4 order-list shadow-sm custom-bg">
                                <div class="gold-members p-4">
                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        $sql = "SELECT * FROM avis_jou WHERE utilisateur_id = $user_id";
