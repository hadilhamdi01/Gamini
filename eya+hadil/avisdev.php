            ...
            <div class="col-md-3">
                <div class="osahan-account-page-left shadow-sm bg h-100 customm-bg">
                    ...
                    <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="btn btn-outline-success" href="addavisdev.php"><i
                                    class="icofont-headphone-alt"></i>Donner votre avis</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="osahan-account-page-right shadow-sm bg p-4 h-100 customm-bg">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane  fade  active show" id="orders" role="tabpanel"
                            ...
                            <h4 class="font-weight-bold mt-0 mb-4">Mes avis</h4>
                            <div class="bg card mb-4 order-list shadow-sm custom-bg">
                                <div class="gold-members p-4">
                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        $sql = "SELECT * FROM avis_dev WHERE utilisateur_id = $user_id";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <span class="float-right text-info">Deliveré le
                                            ...
                                            echo "Aucun avis trouvé pour cet utilisateur.";
                                        }
