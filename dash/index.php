    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="avis_joueur.html" class="nav-item nav-link"><i class="fas fa-comments"></i> Avis Joueur</a>
                <a href="reclamation_joueur.html" class="nav-item nav-link"><i class="fas fa-exclamation-triangle"></i> Reclamation Joueur</a>
                <a href="../src/login_history.php" class="nav-item nav-link"><i class="fas fa-file-import"></i> Historique d'accès</a>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: black">Formulaire de date</h5>
